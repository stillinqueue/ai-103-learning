...
async def connect_to_server(exit_stack: AsyncExitStack):
    ...
    # Invoke one discovered tool as a simple connectivity test
    test_result = await session.call_tool("get_inventory_levels", {})
    print("Test call result:", test_result.content[0].text)
